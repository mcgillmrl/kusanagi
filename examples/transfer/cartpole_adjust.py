...
if __name__ == '__main__':
    ...
    source_experience = ExperienceDataset(filename='PILCO_SSGP_UI_6_4_Cartpole_RBFPolicy_sat_dataset')
    ...
    if not simulation:
        ...
        target_params['params']['plant']['params'] = {'l': 0.8, 'm': .5, 'M': .5, 'b': 0.1, 'g': 9.82}
